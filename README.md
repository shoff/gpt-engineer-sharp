...
GPT Engineer Sharp is a c# dotnet port of the original GPT Engineer project by Anton Osika. It is made to be easy to adapt, extend, and make your agent learn how you want your code to look. It generates an entire codebase based on a prompt.
